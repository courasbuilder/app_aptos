...
st.set_page_config(
    page_title='Sobre o Projeto de valor de apartamentos'
)

st.title(':blue[Projeto de Predição de Preços de Apartamentos]')

st.image("https://media.giphy.com/media/Vdid4881G8lFkPFfeE/giphy.gif", width=400)
...
'''
Elaboração do modelo de Machine Learning para prever o valor dos imóveis.
'''
